%% Analyze the errors into a plot! L2-convergence for fixed M = 3
close all
...
for i = 1 : 6
    N = 2^(i+2);
    % load the workspace
    s = ['Fast Diagonalization truncated\test_schrodinger_degree_' num2str(grad)...
