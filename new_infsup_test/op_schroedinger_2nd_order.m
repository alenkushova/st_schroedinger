...
% 
% Call:               
%                A = op_schroedinger_2nd_order (mshx, msht, test_spx, test_spt, options)
% [rows,cols,vals] = op_schroedinger_2nd_order (mshx, msht, test_spx, test_spt, options)
% 
% Input:       
...
% 
function varargout = op_schroedinger_2nd_order (mshx, msht, trial_spx, trial_spt,...
                                           test_spx, test_spt)
