...
problem_data.boundary_sides = [1 2 4 ];  % Boundary
...
method_data.trial_regularity = [p p] - 1;                                   % Regularity of the trial splines
...
method_data.nquad      = [p p] + 1;                                      % Points for the Gaussian quadrature rule

%% 3) CALL TO THE SOLVER
[geometry, msh, space, u] = solve_schrodinger_dsf_fbv (problem_data, method_data);
