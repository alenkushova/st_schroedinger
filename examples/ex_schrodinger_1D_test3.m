...
problem_data.boundary_sides = [1 2];  % Boundary
problem_data.initial_sides  = 3;  % Initial 
problem_data.final_sides    = 4;  % Final
...
method_data.trial_degree     = [p p+1];                                    % Degree of the trial splines (last is time dir)
...
method_data.nquad      = [p p+1] + 1;                                      % Points for the Gaussian quadrature rule

%% 3) CALL TO THE SOLVER
[geometry, msh, space, u] = solve_schrodinger_dsf_bv (problem_data, method_data);
