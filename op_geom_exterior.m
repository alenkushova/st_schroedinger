function diff_ops = op_geom_exterior (knots, degrees, grad_curl)
...
%     d_univ_vals = scaling(:).*[ -ones(dim_d_univ,1), ones(dim_d_univ,1)];
...
% % %       % DEBUG: Check sequence properties
% % %       disp(diff_ops{2}*diff_ops{1})
